...
public class SEIR : MonoBehaviour
{
    ...
    [HideInInspector]
    public List<Agent_SEIR> Agents = new List<Agent_SEIR>();
    ...
    public void StartSimulation ()
    {
        ...
        for (int i = 0; i < AgentCounts; i ++)
        {
            ...
            Agent_SEIR agent = Instantiate(AgentPrefab, position, Quaternion.identity, transform);
        ...
        {
            Agent_SEIR agent = Agents[Random.Range(0, Agents.Count)];
            // agent.Infect();
